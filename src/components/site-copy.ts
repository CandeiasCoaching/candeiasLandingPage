      ...
      planDetails: {
        ...
        starter: {
          ...
          features: [
            ...
            "Training app",
            "Body Analysis",
            "Constant follow up - online coaching - Whatsapp 24/7",
          ],
          price: "225,00 €",
        },
        standard: {
        ...
        varia: {
          title: "Varia",
          features: [
            "1 hour PT training: 40,00€",
            "1 Training program: 35,00€",
            "1 Meal plan: 35,00€",
            "Training program + meal plan: 50,00€",
            "Full Body analysis: 30,00€",
            "Full Body analysis and meal plan: 50,00€",
            "Full Body analysis and meal plan + training program: 80,00€",
            "Online coaching: 1hour 30,00€",
            "Consult: 1uur 30,00€",
          ],
        },
        back: "Back",
      ...
      planDetails: {
        ...
        starter: {
          ...
          features: [
            ...
            "Training app",
            "Body Analysis",
            "Constante opvolging - online coaching - Whatsapp 24/7",
          ],
          price: "225,00 €",
        },
        standard: {
        ...
        varia: {
          title: "Varia",
          features: [
            "1 uur PT training: 40,00€",
            "1 Trainingsprogramma: 35,00€",
            "1 Voedingsplan: 35,00€",
            "Trainingsprogramma + voedingsplan: 50,00€",
            "Full Body analysis: 30,00€",
            "Full Body analysis en voedingsplan: 50,00€",
            "Full Body analysis en voedingsplan + trainingsprogramma: 80,00€",
            "Online coaching: 1 uur 30,00€",
            "Consult: 1 uur 30,00€",
          ],
        },
        back: "Terug",
